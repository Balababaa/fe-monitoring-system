...
<template>
  <div>
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" prop="roleList" label="角色列表" min-width="300">
        ...
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="success" @click="addRole(scope.$index, scope.row)">角色编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
    ...
    <!-- 增加角色 -->
        <el-dialog title="附加角色" :visible.sync="addRoleFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="120px" :model="addRoleForm" ref="addRoleForm" :rules="rules">
        <el-form-item label="角色" prop="codeList">
          <!-- <el-input size="small" v-model="addRoleForm.code" auto-complete="off" placeholder="请输入角色CODE"></el-input> -->
          <el-select v-model="addRoleForm.codeList" multiple placeholder="请选择">
            <el-option
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="UID" prop="uid">
          <el-input size="small" v-model="editForm.uid" auto-complete="off" placeholder="请输入UID"></el-input>
        </el-form-item>
...
<script>
// 导入请求方法
import { userList, userSave, roleAdd, roleListAll } from '../../api/request'
...
export default {
  ...
  methods: {
    ...
    addRole: function(index, row){
      this.addRoleFormVisible = true;
      this.addRoleForm.uid = row.uid
    ...
    submitAddRoleForm: function(addRoleForm){
